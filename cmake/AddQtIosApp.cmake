...
function(add_qt_ios_app TARGET)
    ...
    if(NOT CMAKE_XCODE_ATTRIBUTE_DEVELOPMENT_TEAM)
        set(CMAKE_XCODE_ATTRIBUTE_DEVELOPMENT_TEAM ${ARGIOS_TEAM_ID})
    endif()
    ...
    if(QT_IOS_VERBOSE)
        ...
        message(STATUS "TEAM_ID                             : ${CMAKE_XCODE_ATTRIBUTE_DEVELOPMENT_TEAM}")
    ...
    if(CMAKE_XCODE_ATTRIBUTE_DEVELOPMENT_TEAM)
        qt_ios_set_xcode_property(${QT_IOS_TARGET} DEVELOPMENT_TEAM ${CMAKE_XCODE_ATTRIBUTE_DEVELOPMENT_TEAM} "All")
    endif()
    if(QT_IOS_PROVISIONING_PROFILE_SPECIFIER)
