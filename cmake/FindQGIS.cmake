...
macro(_find_qgis_library _lib_name _component)
  if(NOT QGIS_${_component}_LIBRARY)
    ...
    message(STATUS "QGIS LIB VAR NAME ${_var_name}")
    set(_path "${${_var_name}}")
    message(STATUS "QGIS LIB PATH ${_path}")
    get_filename_component(PARENT_DIR "${_path}" DIRECTORY)
    get_filename_component(BASE_DIR "${PARENT_DIR}" DIRECTORY)
    find_file(QGIS_${_component}_LIBRARY_DLL NAMES qgis_${_lib_name}.dll PATHS "${BASE_DIR}/bin")
