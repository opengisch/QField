 ...
 */
  ...
  class DecodeHints
  {
    ...
    public:
      ...
      DecodeHints()
        : _tryHarder( 1 ), _tryRotate( 1 ), _tryDownscale( 1 ), _isPure( 0 ), _tryCode39ExtendedMode( 0 ), _validateCode39CheckSum( 0 ), _validateITFCheckSum( 0 ), _returnCodabarStartEnd( 0 ), _binarizer( Binarizer::LocalAverage ), _eanAddOnSymbol( EanAddOnSymbol::Ignore )
      {}
