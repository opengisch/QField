...
![Figure 1: Structure
list](/images/geologic_structure_list.png){width="700px"}
:::
...
::: {.container .clearer .text-center}
![Figure 2: Field work](/images/geologic_field.png){width="700px"}

![Figure 3: QField form](/images/geologic_station_qf.jpg){width="700px"}
:::
...
::: {.container .clearer .text-center}
![Figure 2: Map result](/images/geologic_map.jpg){width="700px"}
:::
