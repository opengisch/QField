...
Item {
  ...
  QfToolButton {
    ...
    iconSource: QfApplicationInformation.hasNearFieldReader ? QfTheme.getThemeVectorIcon("ic_qr_nfc_code_black_24dp") : QfTheme.getThemeVectorIcon("ic_qr_code_black_24dp")
    iconColor: QfTheme.mainTextColor
    bgcolor: "transparent"
