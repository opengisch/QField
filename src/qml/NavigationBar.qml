...
Rectangle {
  ...
  QfMenu {
    ...
    MenuItem {
      ...
      enabled: ((projectInfo.editRights || editButton.isCreatedCloudFeature) && (!selection.focusedLayer || !featureForm.model.featureModel.geometryLocked)) && isGeometryCompatible
      visible: enabled
