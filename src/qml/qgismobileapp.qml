...
ApplicationWindow {
  ...
  visible: true
  flags: Qt.platform.os === "ios" || Qt.platform.os === "android" ? (Screen.width === width && Screen.height === height ? Qt.ExpandedClientAreaHint : 0) | Qt.NoTitleBarBackgroundHint : Qt.Window | Qt.WindowTitleHint | Qt.WindowSystemMenuHint | Qt.WindowMinMaxButtonsHint | Qt.WindowCloseButtonHint | (sceneBorderless ? Qt.FramelessWindowHint : 0)
