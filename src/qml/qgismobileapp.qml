...
ApplicationWindow {
  ...
  Column {
    ...
    DigitizingToolbar {
      ...
      screenHovering: hoverHandler.hovered || (mouseHoverHandler.enabled && mouseHoverHandler.hovered)
  ...
  VertexModel {
      ...
      mapSettings: mapCanvas.mapSettings
      isHovering: hoverHandler.hovered || (mouseHoverHandler.enabled && mouseHoverHandler.hovered)
  }
}
