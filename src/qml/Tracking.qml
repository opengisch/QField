...
Item {
    ...
    RubberbandModel {
        ...
        onVertexCountChanged: {
            if ((geometryType === QgsWkbTypes.LineGeometry && vertexCount > 2) || (geometryType === QgsWkbTypes.PolygonGeometry && vertexCount > 3)) {
                featureModel.applyGeometry();
                if ((geometryType === QgsWkbTypes.LineGeometry && vertexCount == 3) || (geometryType === QgsWkbTypes.PolygonGeometry && vertexCount == 4)) {
                    featureModel.create();
        ...
        Popup {
            ...
            Page {
                ...
                header: PageHeader {
                    ...
                    onApply: {
                        if (Number(timeIntervalText.text) + Number(distanceText.text) === 0 || (timeIntervalCheck.checked && distanceCheck.checked && conjunction.checked && (Number(timeIntervalText.text) === 0 || Number(distanceText.text) === 0))) {
