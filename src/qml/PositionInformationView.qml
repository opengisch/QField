    ...
    Grid {
        ...
        Rectangle {
            ...
            Text {
                ...
                font: Theme.tipFont
                text: positionSource.destinationCrs.isGeographic ? qsTr("Lat.") + ": " + (positionSource.position.latitudeValid ? Number(positionSource.projectedPosition.y).toLocaleString(Qt.locale(), "f", 5) : qsTr("N/A")) : qsTr("X") + ": " + (positionSource.position.longitudeValid ? Number(positionSource.projectedPosition.x).toLocaleString(Qt.locale(), "f", 2) : qsTr("N/A"))
            }
        ...
        Rectangle {
            ...
            Text {
                ...
                anchors.left: parent.left
                font: Theme.tipFont
                text: positionSource.destinationCrs.isGeographic ? qsTr("Lon.") + ": " + (positionSource.position.longitudeValid ? Number(positionSource.projectedPosition.x).toLocaleString(Qt.locale(), "f", 5) : qsTr("N/A")) : qsTr("Y") + ": " + (positionSource.position.latitudeValid ? Number(positionSource.projectedPosition.y).toLocaleString(Qt.locale(), "f", 2) : qsTr("N/A"))
            }
