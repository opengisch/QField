...
PositionSource {
  ...
  */
    ...
    property real projectedHorizontalAccuracy: position.horizontalAccuracyValid && destinationCrs.mapUnits !== QgsUnitTypes.DistanceUnknownUnit ? position.horizontalAccuracy * Utils.distanceFromUnitToUnitFactor(QgsUnitTypes.DistanceMeters, destinationCrs.mapUnits) : 0
