...
class BluetoothReceiver : public QObject
{
    ...
    Q_PROPERTY( bool connected READ connected NOTIFY connectedChanged ) //could be removed when QBluetoothSocket can be accessed by the QML and so would be provided over socketState
