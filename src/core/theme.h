...
public:
  ...
  void setMainColor( const QColor &c ) { if ( mMainColor != c ) { mMainColor = c; emit mainColorChanged(); } }

  QColor mainOverlayColor() const { return mMainOverlayColor; }
  void setMainOverlayColor( const QColor &c ) { if ( mMainOverlayColor != c ) { mMainOverlayColor = c; emit mainOverlayColorChanged(); } }

  QColor mainBackgroundColor() const { return mMainBackgroundColor; }
  void setMainBackgroundColor( const QColor &c ) { if ( mMainBackgroundColor != c ) { mMainBackgroundColor = c; emit mainBackgroundColorChanged(); } }

  QColor mainBackgroundColorSemiOpaque() const { return mMainBackgroundColorSemiOpaque; }
  void setMainBackgroundColorSemiOpaque( const QColor &c ) { if ( mMainBackgroundColorSemiOpaque != c ) { mMainBackgroundColorSemiOpaque = c; emit mainBackgroundColorSemiOpaqueChanged(); } }

  QColor mainTextColor() const { return mMainTextColor; }
  void setMainTextColor( const QColor &c ) { if ( mMainTextColor != c ) { mMainTextColor = c; emit mainTextColorChanged(); } }

  QColor mainTextDisabledColor() const { return mMainTextDisabledColor; }
  void setMainTextDisabledColor( const QColor &c ) { if ( mMainTextDisabledColor != c ) { mMainTextDisabledColor = c; emit mainTextDisabledColorChanged(); } }

  QColor secondaryTextColor() const { return mSecondaryTextColor; }
  void setSecondaryTextColor( const QColor &c ) { if ( mSecondaryTextColor != c ) { mSecondaryTextColor = c; emit secondaryTextColorChanged(); } }

  QColor controlBackgroundColor() const { return mControlBackgroundColor; }
  void setControlBackgroundColor( const QColor &c ) { if ( mControlBackgroundColor != c ) { mControlBackgroundColor = c; emit controlBackgroundColorChanged(); } }

  QColor controlBackgroundAlternateColor() const { return mControlBackgroundAlternateColor; }
  void setControlBackgroundAlternateColor( const QColor &c ) { if ( mControlBackgroundAlternateColor != c ) { mControlBackgroundAlternateColor = c; emit controlBackgroundAlternateColorChanged(); } }

  QColor controlBackgroundDisabledColor() const { return mControlBackgroundDisabledColor; }
  void setControlBackgroundDisabledColor( const QColor &c ) { if ( mControlBackgroundDisabledColor != c ) { mControlBackgroundDisabledColor = c; emit controlBackgroundDisabledColorChanged(); } }

  QColor controlBorderColor() const { return mControlBorderColor; }
  void setControlBorderColor( const QColor &c ) { if ( mControlBorderColor != c ) { mControlBorderColor = c; emit controlBorderColorChanged(); } }

  QColor buttonTextColor() const { return mButtonTextColor; }
  void setButtonTextColor( const QColor &c ) { if ( mButtonTextColor != c ) { mButtonTextColor = c; emit buttonTextColorChanged(); } }

  QColor toolButtonColor() const { return mToolButtonColor; }
  void setToolButtonColor( const QColor &c ) { if ( mToolButtonColor != c ) { mToolButtonColor = c; emit toolButtonColorChanged(); } }

  QColor toolButtonBackgroundColor() const { return mToolButtonBackgroundColor; }
  void setToolButtonBackgroundColor( const QColor &c ) { if ( mToolButtonBackgroundColor != c ) { mToolButtonBackgroundColor = c; emit toolButtonBackgroundColorChanged(); } }

  QColor toolButtonBackgroundSemiOpaqueColor() const { return mToolButtonBackgroundSemiOpaqueColor; }
  void setToolButtonBackgroundSemiOpaqueColor( const QColor &c ) { if ( mToolButtonBackgroundSemiOpaqueColor != c ) { mToolButtonBackgroundSemiOpaqueColor = c; emit toolButtonBackgroundSemiOpaqueColorChanged(); } }

  QColor scrollBarBackgroundColor() const { return mScrollBarBackgroundColor; }
  void setScrollBarBackgroundColor( const QColor &c ) { if ( mScrollBarBackgroundColor != c ) { mScrollBarBackgroundColor = c; emit scrollBarBackgroundColorChanged(); } }

  QColor groupBoxBackgroundColor() const { return mGroupBoxBackgroundColor; }
  void setGroupBoxBackgroundColor( const QColor &c ) { if ( mGroupBoxBackgroundColor != c ) { mGroupBoxBackgroundColor = c; emit groupBoxBackgroundColorChanged(); } }

  QColor groupBoxSurfaceColor() const { return mGroupBoxSurfaceColor; }
  void setGroupBoxSurfaceColor( const QColor &c ) { if ( mGroupBoxSurfaceColor != c ) { mGroupBoxSurfaceColor = c; emit groupBoxSurfaceColorChanged(); } }
  ...
  void setDarkTheme( bool dark ) { if ( mDarkTheme != dark ) { mDarkTheme = dark; emit darkThemeChanged(); } }

  qreal fontScale() const { return mFontScale; }
  void setFontScale( qreal scale ) { if ( !qFuzzyCompare( mFontScale, scale ) ) { mFontScale = scale; emit fontScaleChanged(); } }
