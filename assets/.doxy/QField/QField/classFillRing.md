...
[**ClassList**](annotated.md) **>** [**FillRing**](classFillRing.md)
...
| Type | Name |
| ---: | :--- |
| property alias | [**addPolygonDialog**](classFillRing.md#property-addpolygondialog-12)  <br> |
| property bool | [**blocking**](classFillRing.md#property-blocking)  <br> |
| property alias | [**formPopupLoader**](classFillRing.md#property-formpopuploader-12)  <br> |
| property bool | [**screenHovering**](classFillRing.md#property-screenhovering)  <br> |
...
```C++
alias FillRing::addPolygonDialog;
```
...
```C++
alias FillRing::formPopupLoader;
```
