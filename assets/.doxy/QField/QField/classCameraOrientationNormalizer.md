...
```C++
Q_INVOKABLE bool CameraOrientationNormalizer::applyEditsToImage (
    const QString & path,
    int rotation,
    bool mirror
) 
...
Bakes a user-chosen _rotation_ (clockwise degrees, multiples of 90) and optional horizontal _mirror_ into the JPEG at _path_, letting the user manually adjust a photo before saving.
