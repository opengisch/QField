...
| signal void | [**importEnded**](classAppInterface.md#signal-importended) (const QString & path=QString(), const QString & originalUrl=QString()) <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**AppInterface**](#function-appinterface-12) (QQmlEngine \* engine, [**AppController**](classAppController.md) \* controller=nullptr) <br> |
...
```C++
Q_INVOKABLE void AppInterface::addItemToMapCanvas3D (
    QQuickItem * item
) const
```
...
```C++
Q_INVOKABLE void AppInterface::setupNetworkProxy () const
```
