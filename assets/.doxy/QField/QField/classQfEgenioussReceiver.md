...
# Class QfEgenioussReceiver



[**ClassList**](annotated.md) **>** [**QfEgenioussReceiver**](classQfEgenioussReceiver.md)
...
| Type | Name |
| ---: | :--- |
|   | [**QfEgenioussReceiver**](#function-qfegenioussreceiver) (const QString & address=QString(), const int port=0, QObject \* parent=nullptr) <br> |
| virtual [**QfGnssPositionDetails**](classQfGnssPositionDetails.md) | [**details**](#function-details) () override const<br> |
|   | [**~QfEgenioussReceiver**](#function-qfegenioussreceiver) () override<br> |
...
```C++
QLatin1String QfEgenioussReceiver::identifier;
```
...
### function QfEgenioussReceiver 

```C++
explicit QfEgenioussReceiver::QfEgenioussReceiver (
...
```C++
virtual QfGnssPositionDetails QfEgenioussReceiver::details () override const
```
...
Implements [*QfAbstractGnssReceiver::details*](classQfAbstractGnssReceiver.md#function-details)
...
```C++
QfEgenioussReceiver::~QfEgenioussReceiver () override
```
