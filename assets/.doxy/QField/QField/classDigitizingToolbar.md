...
Inherits the following classes: [QfDigitizingToolbar](classQfDigitizingToolbar.md)
...
## Public Properties inherited from QfDigitizingToolbar

See [QfDigitizingToolbar](classQfDigitizingToolbar.md)
...
| property [**RubberbandModel**](classRubberbandModel.md) | [**rubberbandModel**](classQfDigitizingToolbar.md#property-rubberbandmodel)  <br> |
...
## Public Signals inherited from QfDigitizingToolbar
...
## Public Functions inherited from QfDigitizingToolbar

See [QfDigitizingToolbar](classQfDigitizingToolbar.md)

| Type | Name |
| ---: | :--- |
|  void | [**addVertex**](classQfDigitizingToolbar.md#function-addvertex) () <br> |
|  void | [**checkAccuracyRequirement**](classQfDigitizingToolbar.md#function-checkaccuracyrequirement) () <br> |
|  void | [**checkGeometryValidity**](classQfDigitizingToolbar.md#function-checkgeometryvalidity) () <br> |
|  void | [**confirm**](classQfDigitizingToolbar.md#function-confirm) () <br> |
|  void | [**removeVertex**](classQfDigitizingToolbar.md#function-removevertex) () <br> |
|  void | [**triggerAddVertex**](classQfDigitizingToolbar.md#function-triggeraddvertex) () <br> |
...
------------------------------
The documentation for this class was generated from the following file `src/app/qml_compat/DigitizingToolbar.qml`
