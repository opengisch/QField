...
| property double | [**deviceBatteryLevel**](classPositioning.md#property-devicebatterylevel-12)  <br> |
...
| property bool | [**enableNtrip**](classPositioning.md#property-enablentrip-12)  <br> |
...
| property qint64 | [**ntripBytesReceived**](classPositioning.md#property-ntripbytesreceived-12)  <br> |
| property qint64 | [**ntripBytesSent**](classPositioning.md#property-ntripbytessent-12)  <br> |
| property QDateTime | [**ntripLastBytesReceivedUtcDateTime**](classPositioning.md#property-ntriplastbytesreceivedutcdatetime-12)  <br> |
| property [**NtripSettings**](classNtripSettings.md) | [**ntripSettings**](classPositioning.md#property-ntripsettings-12)  <br> |
| property [**PositioningSource::NtripState**](classPositioningSource.md#enum-ntripstate) | [**ntripState**](classPositioning.md#property-ntripstate-12)  <br> |
...
| signal void | [**deviceBatteryLevelChanged**](classPositioning.md#signal-devicebatterylevelchanged)  <br> |
| signal void | [**deviceChanged**](classPositioning.md#signal-devicechanged)  <br> |
...
| signal void | [**enableNtripChanged**](classPositioning.md#signal-enablentripchanged)  <br> |
...
| signal void | [**ntripBytesReceivedChanged**](classPositioning.md#signal-ntripbytesreceivedchanged)  <br> |
| signal void | [**ntripBytesSentChanged**](classPositioning.md#signal-ntripbytessentchanged)  <br> |
| signal void | [**ntripLastBytesReceivedUtcDateTimeChanged**](classPositioning.md#signal-ntriplastbytesreceivedutcdatetimechanged)  <br> |
| signal void | [**ntripSettingsChanged**](classPositioning.md#signal-ntripsettingschanged)  <br> |
| signal void | [**ntripStateChanged**](classPositioning.md#signal-ntripstatechanged)  <br> |
...
|  [**PositioningSource::NtripState**](classPositioningSource.md#enum-ntripstate) | [**ntripState**](#function-ntripstate-22) () const<br> |
...
```C++
double Positioning::deviceBatteryLevel;
```
...
```C++
qint64 Positioning::ntripBytesReceived;
```
...
```C++
qint64 Positioning::ntripBytesSent;
```
...
```C++
QDateTime Positioning::ntripLastBytesReceivedUtcDateTime;
```
...
```C++
NtripSettings Positioning::ntripSettings;
```
...
```C++
PositioningSource::NtripState Positioning::ntripState;
```
...
```C++
void Positioning::deviceBatteryLevelChanged;
```
...
```C++
void Positioning::deviceChanged;
```
...
```C++
void Positioning::enableNtripChanged;
```
...
```C++
void Positioning::ntripBytesReceivedChanged;
```
...
```C++
void Positioning::ntripBytesSentChanged;
```
...
```C++
void Positioning::ntripLastBytesReceivedUtcDateTimeChanged;
```
...
```C++
void Positioning::ntripSettingsChanged;
```
...
```C++
void Positioning::ntripStateChanged;
```
...
```C++
void Positioning::setEnableNtrip (
    bool enableNtrip
) 
```
...
```C++
void Positioning::setNtripSettings (
