...
| signal void | [**printEnded**](classQgisMobileapp.md#signal-printended) (bool success, const QString & folderPath) <br> |
| signal void | [**printProgress**](classQgisMobileapp.md#signal-printprogress) (double progress) <br> |
| signal void | [**printTriggered**](classQgisMobileapp.md#signal-printtriggered) (const QString & name) <br> |
...
* `success` Whether the layout made it to a PDF file 
* `folderPath` The folder the output was written into, empty when the print failed 
...
```C++
void QgisMobileapp::printProgress;
```
...
* `progress` The progress, between 0.0 and 1.0 
...
### signal printTriggered 

```C++
void QgisMobileapp::printTriggered;
```
...
* `name` The name of the layout being printed 
...
TRUE if the print was started, its outcome is reported through [**printEnded()**](classQgisMobileapp.md#signal-printended) 
