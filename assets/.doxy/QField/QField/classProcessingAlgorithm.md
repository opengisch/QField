...
| property QVariantList | [**inPlaceFeatures**](classProcessingAlgorithm.md#property-inplacefeatures-12)  <br> |
...
| property QVariantList | [**previewGeometries**](classProcessingAlgorithm.md#property-previewgeometries-12)  <br> |
...
|  QVariantList | [**inPlaceFeaturesVariant**](#function-inplacefeaturesvariant) () const<br> |
...
|  QVariantList | [**previewGeometries**](#function-previewgeometries-22) () const<br> |
...
|  void | [**setInPlaceFeaturesVariant**](#function-setinplacefeaturesvariant) (const QVariantList & features) <br> |
...
```C++
QVariantList ProcessingAlgorithm::inPlaceFeatures;
```
...
```C++
QVariantList ProcessingAlgorithm::previewGeometries;
```
...
### function inPlaceFeaturesVariant 
...
Returns the vector _layer_ for in-place algorithm filter as a QVariantList. 
...
```C++
inline QVariantList ProcessingAlgorithm::previewGeometries () const
```
...
### function setInPlaceFeaturesVariant 

```C++
void ProcessingAlgorithm::setInPlaceFeaturesVariant (
...
Sets the vector _layer_ for in-place algorithm filter from a QVariantList. 
