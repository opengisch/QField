...
|  QVariantList | [**polylines**](#function-polylines-22) () const<br>_List of polylines representing the geometry._  |
...
```C++
QVariantList LinePolygonShape::polylines;
```
...
_List of polylines representing the geometry._ 
```C++
inline QVariantList LinePolygonShape::polylines () const
```
