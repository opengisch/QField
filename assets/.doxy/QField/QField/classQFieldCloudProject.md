...
| property QDateTime | [**dataLastUpdatedAt**](classQFieldCloudProject.md#property-datalastupdatedat-12)  <br> |
...
| property QDateTime | [**lastLocalExportedAt**](classQFieldCloudProject.md#property-lastlocalexportedat-12)  <br> |
| property QDateTime | [**lastLocalPushDeltas**](classQFieldCloudProject.md#property-lastlocalpushdeltas-12)  <br> |
...
| property qint64 | [**remoteSizeBytes**](classQFieldCloudProject.md#property-remotesizebytes-12)  <br> |
...
| signal void | [**downloaded**](classQFieldCloudProject.md#signal-downloaded) (const QString & error=QString()) <br> |
...
| signal void | [**remoteSizeBytesChanged**](classQFieldCloudProject.md#signal-remotesizebyteschanged)  <br> |
...
```C++
QDateTime QFieldCloudProject::dataLastUpdatedAt;
```
...
```C++
QDateTime QFieldCloudProject::lastLocalExportedAt;
```
...
```C++
QDateTime QFieldCloudProject::lastLocalPushDeltas;
```
...
```C++
qint64 QFieldCloudProject::remoteSizeBytes;
```
...
```C++
void QFieldCloudProject::remoteSizeBytesChanged;
```
...
```C++
inline QDateTime QFieldCloudProject::lastLocalExportedAt () const
```
...
```C++
inline QDateTime QFieldCloudProject::lastLocalPushDeltas () const
```
...
```C++
inline qint64 QFieldCloudProject::remoteSizeBytes () const
```
...
```C++
void QFieldCloudProject::setRemoteSizeBytes (
