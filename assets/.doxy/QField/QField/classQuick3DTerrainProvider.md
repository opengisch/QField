...
Converts a 3D scene position back to geographic coordinates in map CRS. Inverse of [**geoTo3D()**](classQuick3DTerrainProvider.md#function-geoto3d); returns an empty QgsPoint when the extent is invalid. 
