...
| property bool | [**isTransitioning**](classQuick3DTerrainProvider.md#property-istransitioning-12)  <br>_Whether a transition to apply pan/zoom offsets has begun._  |
...
| property QgsRectangle | [**normalizedDataExtent**](classQuick3DTerrainProvider.md#property-normalizeddataextent-12)  <br>_Geographic extent used for terrain data._  |
| property double | [**offsetScale**](classQuick3DTerrainProvider.md#property-offsetscale-12)  <br>_Offset scale from the last generated terrain data._  |
| property QVector3D | [**offsetVector**](classQuick3DTerrainProvider.md#property-offsetvector-12)  <br>_Offset vector from the last generated terrain data._  |
...
| signal void | [**isTransitioningChanged**](classQuick3DTerrainProvider.md#signal-istransitioningchanged)  <br> |
...
| signal void | [**offsetScaleChanged**](classQuick3DTerrainProvider.md#signal-offsetscalechanged)  <br> |
| signal void | [**offsetVectorChanged**](classQuick3DTerrainProvider.md#signal-offsetvectorchanged)  <br> |
...
|  Q\_INVOKABLE void | [**beginTransition**](#function-begintransition) () <br>_Regenerates the extent and terrain data from current offset._  |
|  Q\_INVOKABLE void | [**endTransition**](#function-endtransition) () <br>_Applies offsets and reset values to zeros._  |
|  QgsRectangle | [**extent**](#function-extent-22) () const<br>_Returns the current extent taking into account offsets._  |
|  bool | [**forceSquareSize**](#function-forcesquaresize-22) () const<br> |
|  Q\_INVOKABLE QVector3D | [**geoTo3D**](#function-geoto3d-12) (double geoX, double geoY, float heightOffset=0.0f) const<br> |
|  Q\_INVOKABLE QVector3D | [**geoTo3D**](#function-geoto3d-22) (const QgsPoint & geoPoint, float heightOffset=0.0f) const<br> |
...
|  bool | [**isTransitioning**](#function-istransitioning-22) () const<br> |
...
|  QgsRectangle | [**normalizedDataExtent**](#function-normalizeddataextent-22) () const<br>_Returns the geographic extent for the retrieved terrain data._  |
|  Q\_INVOKABLE double | [**normalizedHeightAt**](#function-normalizedheightat) (double x, double y) const<br> |
|  double | [**offsetScale**](#function-offsetscale-22) () const<br>_Returns the offset scale from the last generated terrain data._  |
|  QVector3D | [**offsetVector**](#function-offsetvector-22) () const<br>_Returns the offset scale from the last generated terrain data._  |
|  Q\_INVOKABLE void | [**pan**](#function-pan) (double x, double z) <br>_Applies X/Z offsets to the stored terrain based on pan action._  |
...
|  Q\_INVOKABLE QgsPoint | [**scene3DToGeo**](#function-scene3dtogeo) (double sceneX, double sceneZ) const<br> |
...
|  Q\_INVOKABLE void | [**zoom**](#function-zoom) (double factor) <br>_Applies scale offset to the stored terrain based on zoom action._  |
...
_Whether a transition to apply pan/zoom offsets has begun._ 
```C++
...
_Offset scale from the last generated terrain data._ 
```C++
...
_Offset vector from the last generated terrain data._ 
```C++
...
_Regenerates the extent and terrain data from current offset._ 
```C++
...
_Applies offsets and reset values to zeros._ 
```C++
...
_Returns the current extent taking into account offsets._ 
```C++
...
* `geoPoint` Point coordinate in map CRS 
...
_Returns the geographic extent for the retrieved terrain data._ 
```C++
...
_Returns the offset scale from the last generated terrain data._ 
```C++
...
_Applies X/Z offsets to the stored terrain based on pan action._ 
```C++
...
```C++
Q_INVOKABLE QgsPoint Quick3DTerrainProvider::scene3DToGeo (
    double sceneX,
    double sceneZ
) const
```
...
Converts a 3D scene position back to geographic coordinates in map CRS. Inverse of [**geoTo3D()**](classQuick3DTerrainProvider.md#function-geoto3d-12); returns an empty QgsPoint when the extent is invalid. 
...
_Applies scale offset to the stored terrain based on zoom action._ 
```C++
...
------------------------------
The documentation for this class was generated from the following file `src/3d/quick3dterrainprovider.h`
