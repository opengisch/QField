...
# Class QfProjectUtils



[**ClassList**](annotated.md) **>** [**QfProjectUtils**](classQfProjectUtils.md)
...
| Type | Name |
| ---: | :--- |
|   | [**QfProjectUtils**](#function-qfprojectutils) (QObject \* parent=nullptr) <br> |
...
|  Q\_INVOKABLE QList&lt; QColor &gt; | [**colorPresets**](#function-colorpresets) (QgsProject \* project=nullptr) <br> |
|  Q\_INVOKABLE QString | [**createProject**](#function-createproject) (const QVariantMap & options, const [**QfGnssPositionInformation**](classQfGnssPositionInformation.md) & positionInformation=[**QfGnssPositionInformation**](classQfGnssPositionInformation.md)()) <br> |
...
### function QfProjectUtils 

```C++
explicit QfProjectUtils::QfProjectUtils (
...
```C++
static Q_INVOKABLE bool QfProjectUtils::addMapLayer (
    QgsProject * project,
    QgsMapLayer * layer
) 
```
...
```C++
static Q_INVOKABLE QList< QColor > QfProjectUtils::colorPresets (
...
Returns the color presets for a given _project_. 
...
```C++
static Q_INVOKABLE QString QfProjectUtils::createProject (
...
```C++
static Q_INVOKABLE QVariantMap QfProjectUtils::mapLayers (
    QgsProject * project
) 
```
...
```C++
static Q_INVOKABLE void QfProjectUtils::removeMapLayer (
    QgsProject * project,
    QgsMapLayer * layer
) 
```
...
```C++
static Q_INVOKABLE QString QfProjectUtils::title (
    QgsProject * project=nullptr
) 
```
...
```C++
static Q_INVOKABLE Qgis::TransactionMode QfProjectUtils::transactionMode (
    QgsProject * project=nullptr
) 
```
...
------------------------------
The documentation for this class was generated from the following file `src/core/utils/qfprojectutils.h`
