...
| Type | Name |
| ---: | :--- |
| property bool | [**isSearching**](classQFieldCloudProjectsFilterModel.md#property-issearching-12)  <br> |
...
| signal void | [**isSearchingChanged**](classQFieldCloudProjectsFilterModel.md#signal-issearchingchanged)  <br> |
...
```C++
bool QFieldCloudProjectsFilterModel::isSearching;
```
...
```C++
void QFieldCloudProjectsFilterModel::isSearchingChanged;
```
