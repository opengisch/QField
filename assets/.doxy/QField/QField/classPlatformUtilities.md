...
| virtual Q\_INVOKABLE [**ResourceSource**](classResourceSource.md) \* | [**getFile**](#function-getfile) (const QString & prefix, const QString & filePath, const QString & mimeType=QStringLiteral("\*/\*"), QObject \* parent=nullptr) <br> |
...
```C++
virtual Q_INVOKABLE void PlatformUtilities::sendCompressedFilesTo (
...
```C++
virtual Q_INVOKABLE QString PlatformUtilities::systemLocalDataLocation (
