...
| property real | [**crossHalfLength**](classCoordinateLocator.md#property-crosshalflength)  <br> |
...
| property color | [**cursorFillColor**](classCoordinateLocator.md#property-cursorfillcolor)  <br> |
| property color | [**cursorOutlineColor**](classCoordinateLocator.md#property-cursoroutlinecolor)  <br> |
| property real | [**cursorSizeScale**](classCoordinateLocator.md#property-cursorsizescale)  <br> |
...
```C++
real CoordinateLocator::crossHalfLength;
```
...
```C++
color CoordinateLocator::cursorFillColor;
```
...
```C++
color CoordinateLocator::cursorOutlineColor;
```
...
```C++
real CoordinateLocator::cursorSizeScale;
```
