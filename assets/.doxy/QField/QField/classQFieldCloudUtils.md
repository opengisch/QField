...
| Type | Name |
| ---: | :--- |
| property QString | [**errorCodeOverQuota**](classQFieldCloudUtils.md#property-errorcodeoverquota-12)  <br> |
| property QString | [**errorCodePlanInsufficient**](classQFieldCloudUtils.md#property-errorcodeplaninsufficient-12)  <br> |
...
|  QList&lt; [**QFieldCloudDelta**](structQFieldCloudDelta.md) &gt; | [**parseDeltaJsonDocument**](#function-parsedeltajsondocument) (const QJsonDocument & jsonDocument, QString & errorString, bool & isValid) <br> |
...
```C++
QString QFieldCloudUtils::errorCodeOverQuota;
```
...
```C++
QString QFieldCloudUtils::errorCodePlanInsufficient;
```
...
```C++
static QList< QFieldCloudDelta > QFieldCloudUtils::parseDeltaJsonDocument (
...
```C++
static Q_INVOKABLE QString QFieldCloudUtils::subscriptionManagementUrl (
...
```C++
static QString QFieldCloudUtils::summarizeDeltaContent (
