...
| Type | Name |
| ---: | :--- |
| property double | [**desiredHeight**](classColor.md#property-desiredheight)  <br> |
...
------------------------------
The documentation for this class was generated from the following file `src/qml/editorwidgets/Color.qml`
