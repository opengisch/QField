...
| signal void | [**printEnded**](classQfAppInterface.md#signal-printended) (bool success, const QString & folderPath) <br> |
| signal void | [**printProgress**](classQfAppInterface.md#signal-printprogress) (double progress) <br> |
| signal void | [**printTriggered**](classQfAppInterface.md#signal-printtriggered) (const QString & name) <br> |
...
```C++
void QfAppInterface::printEnded;
```



Emitted when a print has ended, _success_ telling whether a PDF was written. 
...
```C++
void QfAppInterface::printProgress;
```



Emitted when an ongoing print reports its _progress_. 

**Note:**

only atlas prints report progress, others stay indefinite 
...
```C++
void QfAppInterface::printTriggered;
```
...
TRUE if the print was started, its outcome is reported through [**printEnded()**](classQfAppInterface.md#signal-printended) 
