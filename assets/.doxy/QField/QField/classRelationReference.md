...
[**ClassList**](annotated.md) **>** [**RelationReference**](classRelationReference.md)
...
| Type | Name |
| ---: | :--- |
| property bool | [**showOpenFormButton**](classRelationReference.md#property-showopenformbutton)  <br> |
...
### property showOpenFormButton 

```C++
bool RelationReference::showOpenFormButton;
```
...
------------------------------
The documentation for this class was generated from the following file `src/qml/editorwidgets/RelationReference.qml`
