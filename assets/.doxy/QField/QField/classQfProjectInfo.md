...
| Type | Name |
| ---: | :--- |
| property [**QfMarkupCollection**](classQfMarkupCollection.md) \* | [**activeCollection**](classQfProjectInfo.md#property-activecollection-12)  <br> |
...
| property [**QfMarkupManager**](classQfMarkupManager.md) \* | [**markups**](classQfProjectInfo.md#property-markups)  <br> |
...
| Type | Name |
| ---: | :--- |
| signal void | [**activeCollectionChanged**](classQfProjectInfo.md#signal-activecollectionchanged)  <br> |
...
| signal void | [**markupManagerChanged**](classQfProjectInfo.md#signal-markupmanagerchanged)  <br> |
...
|  [**QfMarkupCollection**](classQfMarkupCollection.md) \* | [**activeCollection**](#function-activecollection-22) () const<br> |
...
|  Q\_INVOKABLE void | [**restoreVisibleMarkupCollections**](#function-restorevisiblemarkupcollections) () <br> |
...
|  Q\_INVOKABLE void | [**saveVisibleMarkupCollections**](#function-savevisiblemarkupcollections) () <br> |
|  void | [**setActiveCollection**](#function-setactivecollection) ([**QfMarkupCollection**](classQfMarkupCollection.md) \* collection) <br> |
...
### property activeCollection [1/2]

```C++
QfMarkupCollection * QfProjectInfo::activeCollection;
```
...
```C++
QfMarkupManager * QfProjectInfo::markups;
```
...
### signal activeCollectionChanged 

```C++
void QfProjectInfo::activeCollectionChanged;
```
...
```C++
void QfProjectInfo::markupManagerChanged;
```
...
Returns the saved active markup collection for the current project or nullptr if the active markup collection was not saved or isn't present 
...
### function restoreVisibleMarkupCollections 

```C++
Q_INVOKABLE void QfProjectInfo::restoreVisibleMarkupCollections () 
```
...
### function saveVisibleMarkupCollections 

```C++
Q_INVOKABLE void QfProjectInfo::saveVisibleMarkupCollections () 
```
...
```C++
void QfProjectInfo::setActiveCollection (
...
Saves the active markup _collection_ within the current project 
...
```C++
void QfProjectInfo::setMarkupManager (
