...
|  [**Geometry**](classGeometry.md) \* | [**geometry**](#function-geometry-22) () <br>_Returns the geometry object that will drive the feature geometry._  |
...
|  void | [**setGeometry**](#function-setgeometry) ([**Geometry**](classGeometry.md) \* geometry) <br>_Sets the geometry object that will drive the feature geometry._  |
...
_Returns the geometry object that will drive the feature geometry._ 
```C++
Geometry * FeatureModel::geometry () 
```
...
_Sets the geometry object that will drive the feature geometry._ 
```C++
