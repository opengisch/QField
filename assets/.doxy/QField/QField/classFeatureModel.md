...
| property QVariantList | [**features**](classFeatureModel.md#property-features-12)  <br> |
...
|  QVariantList | [**featuresVariant**](#function-featuresvariant) () const<br> |
...
|  void | [**setFeaturesVariant**](#function-setfeaturesvariant) (const QVariantList & features) <br> |
...
```C++
QVariantList FeatureModel::features;
```
...
### function setFeaturesVariant 

```C++
void FeatureModel::setFeaturesVariant (
