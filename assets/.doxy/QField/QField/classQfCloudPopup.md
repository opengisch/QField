...
| property bool | [**isSynchronizing**](classQfCloudPopup.md#property-issynchronizing)  <br> |
| property bool | [**isUploading**](classQfCloudPopup.md#property-isuploading)  <br> |
...
```C++
bool QfCloudPopup::isSynchronizing;
```
