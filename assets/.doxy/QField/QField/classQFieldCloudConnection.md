...
| Type | Name |
| ---: | :--- |
| property QVariantList | [**availableProviders**](classQFieldCloudConnection.md#property-availableproviders-12)  <br> |
...
| property [**CloudServerInformation**](structCloudServerInformation.md) | [**serverInformation**](classQFieldCloudConnection.md#property-serverinformation-12)  <br> |
...
| signal void | [**serverInformationChanged**](classQFieldCloudConnection.md#signal-serverinformationchanged)  <br> |
...
| signal void | [**subscriptionInformationReceived**](classQFieldCloudConnection.md#signal-subscriptioninformationreceived) (const [**CloudSubscriptionInformation**](structCloudSubscriptionInformation.md) & subscriptionInformation) <br> |
...
| signal void | [**userOrganizationsReceived**](classQFieldCloudConnection.md#signal-userorganizationsreceived) (const QStringList & organizations) <br> |
...
|  QVariantList | [**availableProviders**](#function-availableproviders-22) () const<br> |
...
|  [**CloudServerInformation**](structCloudServerInformation.md) | [**serverInformation**](#function-serverinformation-22) () const<br> |
...
```C++
QVariantList QFieldCloudConnection::availableProviders;
```
...
```C++
CloudServerInformation QFieldCloudConnection::serverInformation;
```
...
```C++
void QFieldCloudConnection::serverInformationChanged;
```
...
```C++
void QFieldCloudConnection::subscriptionInformationReceived;
```
...
```C++
void QFieldCloudConnection::userOrganizationsReceived;
```
...
```C++
Q_INVOKABLE void QFieldCloudConnection::getServerInformation () 
```
...
```C++
Q_INVOKABLE void QFieldCloudConnection::getSubscriptionInformation (
    const QString & user
) 
```
...
```C++
Q_INVOKABLE void QFieldCloudConnection::getUserOrganizations (
    const QString & user
) 
```
...
```C++
inline CloudServerInformation QFieldCloudConnection::serverInformation () const
```
