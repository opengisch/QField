...
| property [**CloudWhitelabelInformation**](structCloudWhitelabelInformation.md) | [**whitelabel**](classQFieldCloudConnection.md#property-whitelabel-12)  <br> |
...
| signal void | [**whitelabelChanged**](classQFieldCloudConnection.md#signal-whitelabelchanged)  <br> |
...
|  [**CloudWhitelabelInformation**](structCloudWhitelabelInformation.md) | [**whitelabel**](#function-whitelabel-22) () const<br> |
|   | [**~QFieldCloudConnection**](#function-qfieldcloudconnection) () <br> |
...
### property whitelabel [1/2]

```C++
CloudWhitelabelInformation QFieldCloudConnection::whitelabel;
```
...
### signal whitelabelChanged 

```C++
void QFieldCloudConnection::whitelabelChanged;
```
...
### function whitelabel [2/2]

```C++
inline CloudWhitelabelInformation QFieldCloudConnection::whitelabel () const
```
