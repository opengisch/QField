...
| Type | Name |
| ---: | :--- |
|  Q\_INVOKABLE QColor | [**defaultColor**](#function-defaultcolor) () <br>_Returns the default color._  |
|  Q\_INVOKABLE QColor | [**defaultOutlineColor**](#function-defaultoutlinecolor) () <br>_Returns the default outline color._  |
...
_Returns the default color._ 
```C++
static inline Q_INVOKABLE QColor QfRubberbandShape::defaultColor () 
```
...
_Returns the default outline color._ 
```C++
static inline Q_INVOKABLE QColor QfRubberbandShape::defaultOutlineColor () 
```
