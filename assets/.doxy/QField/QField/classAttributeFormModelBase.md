...
| signal void | [**isWizardChanged**](classAttributeFormModelBase.md#signal-iswizardchanged)  <br> |
...
```C++
void AttributeFormModelBase::isWizardChanged;
```
...
```C++
void AttributeFormModelBase::setIsWizard (
    bool isWizard
) 
```
...
------------------------------
The documentation for this class was generated from the following file `src/gui/attributeformmodelbase.h`
