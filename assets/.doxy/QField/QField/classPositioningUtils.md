...
|  Q\_INVOKABLE [**NtripSettings**](classNtripSettings.md) | [**createNtripSettings**](#function-createntripsettings) (const QVariantMap & settings) <br> |
...
```C++
static Q_INVOKABLE NtripSettings PositioningUtils::createNtripSettings (
