...
| Type | Name |
| ---: | :--- |
|  [**GnssPositionInformation**](classGnssPositionInformation.md) | [**averagedPositionInformation**](#function-averagedpositioninformation-12) (const QList&lt; [**GnssPositionInformation**](classGnssPositionInformation.md) &gt; & positionsInformation) <br> |
...
|  QgsRectangle | [**createExtentForDevice**](#function-createextentfordevice) (const [**GnssPositionInformation**](classGnssPositionInformation.md) & positionInformation, const QgsCoordinateReferenceSystem & crs=QgsCoordinateReferenceSystem::fromEpsgId(4326)) <br> |
