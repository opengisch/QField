...
[**ClassList**](annotated.md) **>** [**QfAuthUtils**](classQfAuthUtils.md)
...
| Type | Name |
| ---: | :--- |
|   | [**QfAuthUtils**](#function-qfauthutils) (QObject \* parent=nullptr) <br> |
...
### function QfAuthUtils 

```C++
explicit QfAuthUtils::QfAuthUtils (
...
```C++
static Q_INVOKABLE QVariantList QfAuthUtils::authenticationConfigurationDetails (
...
```C++
static Q_INVOKABLE void QfAuthUtils::clearAuthenticationConfigurationCache (
    const QString & id=QString()
) 
```
...
```C++
static Q_INVOKABLE bool QfAuthUtils::hasAuthenticationConfigurations () 
```
...
```C++
static Q_INVOKABLE bool QfAuthUtils::isAuthenticationConfigurationAvailable (
    const QString & id
) 
```
...
------------------------------
The documentation for this class was generated from the following file `src/core/utils/qfauthutils.h`
