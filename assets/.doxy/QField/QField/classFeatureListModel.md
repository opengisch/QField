...
```C++
bool FeatureListModel::orderByField;
```
...
```C++
QString FeatureListModel::orderByFieldName;
```
...
```C++
void FeatureListModel::orderByFieldChanged;
```
...
```C++
void FeatureListModel::orderByFieldNameChanged;
```
...
```C++
void FeatureListModel::setOrderByField (
    bool orderByField
) 
```
...
```C++
void FeatureListModel::setOrderByFieldName (
