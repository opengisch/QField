...
| signal void | [**projectPluginEnabled**](classPluginManager.md#signal-projectpluginenabled)  <br> |
...
```C++
void PluginManager::projectPluginEnabled;
```
...
```C++
Q_INVOKABLE void PluginManager::denyProjectPluginPermission (
    const QString & path
) 
```
...
```C++
Q_INVOKABLE bool PluginManager::isProjectPluginEnabled (
    const QString & path
) const
```
...
------------------------------
The documentation for this class was generated from the following file `src/app/pluginmanager.h`
