...
[**ClassList**](annotated.md) **>** [**TextEdit**](classTextEdit.md)
...
| Type | Name |
| ---: | :--- |
| property bool | [**isEditable**](classTextEdit.md#property-iseditable)  <br> |
...
| Type | Name |
| ---: | :--- |
|  void | [**commitValue**](#function-commitvalue) (text) <br> |
|  void | [**requestedBarcodeReceived**](#function-requestedbarcodereceived) (string) <br> |
...
```C++
void TextEdit::requestedBarcodeReceived (
    string
) 
```
...
------------------------------
The documentation for this class was generated from the following file `src/qml/editorwidgets/TextEdit.qml`
