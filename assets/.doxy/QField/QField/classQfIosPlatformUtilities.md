...
| virtual void | [**sendCompressedFolderTo**](#function-sendcompressedfolderto) (const QString & path, const QString & fileName=QString()) override const<br> |
...
|  Q\_INVOKABLE bool | [**renameFileWithSidecars**](classQfPlatformUtilities.md#function-renamefilewithsidecars) (const QString & oldFilePath, const QString & newFilePath, bool overwrite=true) const<br> |
...
| virtual Q\_INVOKABLE void | [**sendCompressedFolderTo**](classQfPlatformUtilities.md#function-sendcompressedfolderto) (const QString & path, const QString & fileName=QString()) const<br> |
