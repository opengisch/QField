...
| property QVariantList | [**annotations**](classGridModel.md#property-annotations-12)  <br> |
...
| property QString | [**majorLinesPath**](classGridModel.md#property-majorlinespath-12)  <br> |
...
| property QString | [**markersPath**](classGridModel.md#property-markerspath-12)  <br> |
| property QColor | [**minorLineColor**](classGridModel.md#property-minorlinecolor-12)  <br> |
| property QString | [**minorLinesPath**](classGridModel.md#property-minorlinespath-12)  <br> |
...
|  QVariantList | [**annotations**](#function-annotations-22) () const<br>_Returns the grid annotations._  |
...
```C++
QVariantList GridModel::annotations;
```
...
```C++
QString GridModel::majorLinesPath;
```
...
```C++
QString GridModel::minorLinesPath;
```
...
```C++
inline QVariantList GridModel::annotations () const
```
...
```C++
inline QString GridModel::majorLinesPath () const
```
...
```C++
inline QString GridModel::markersPath () const
```
...
```C++
inline QString GridModel::minorLinesPath () const
```
