...
| enum  | [**RotationSource**](#enum-rotationsource)  <br> |
...
| property bool | [**enableNtrip**](classPositioningSettings.md#property-enablentrip)  <br> |
...
| property var | [**ntripSettings**](classPositioningSettings.md#property-ntripsettings)  <br> |
...
| property bool | [**preciseViewAutoRotate**](classPositioningSettings.md#property-preciseviewautorotate)  <br> |
...
| property int | [**preciseViewRotationSource**](classPositioningSettings.md#property-preciseviewrotationsource)  <br> |
...
```C++
enum PositioningSettings::RotationSource {
    Compass,
    Movement
};
```
...
```C++
bool PositioningSettings::enableNtrip;
```
...
```C++
var PositioningSettings::ntripSettings;
```
...
```C++
bool PositioningSettings::preciseViewAutoRotate;
```
...
```C++
int PositioningSettings::preciseViewRotationSource;
```
