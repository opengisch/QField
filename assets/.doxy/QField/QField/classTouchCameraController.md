...
| property bool | [**extentMode**](classTouchCameraController.md#property-extentmode)  <br> |
...
| Type | Name |
| ---: | :--- |
| signal void | [**extentPan**](classTouchCameraController.md#signal-extentpan) (real sceneX, real sceneZ) <br> |
| signal void | [**extentPanFinished**](classTouchCameraController.md#signal-extentpanfinished)  <br> |
| signal void | [**extentZoom**](classTouchCameraController.md#signal-extentzoom) (real factor) <br> |
| signal void | [**extentZoomFinished**](classTouchCameraController.md#signal-extentzoomfinished)  <br> |
...
```C++
bool TouchCameraController::extentMode;
```
...
```C++
void TouchCameraController::extentPan;
```
...
```C++
void TouchCameraController::extentPanFinished;
```
...
```C++
void TouchCameraController::extentZoom;
```
...
```C++
void TouchCameraController::extentZoomFinished;
```
