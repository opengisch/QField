...
# File QfLocalDataPickerScreen.qml

[**File List**](files.md) **>** [**app**](dir_5194e5fea318fda12687127c23f8aba1.md) **>** [**qml**](dir_408f7dc2ccecf14179dc3d37678eaa5b.md) **>** [**QfLocalDataPickerScreen.qml**](QfLocalDataPickerScreen_8qml.md)

[Go to the documentation of this file](QfLocalDataPickerScreen_8qml.md)
  ...
  ColumnLayout {
    ...
    QfMenu {
      ...
      MenuItem {
        ...
        onTriggered: {
          let projectName = actionButton.isCloudProject && cloudProjectsModel.currentProject ? cloudProjectsModel.currentProject.name : QfFileUtils.fileName(projectInfo.filePath, false);
          platformUtilities.sendCompressedFolderTo(QfFileUtils.absolutePath(projectInfo.filePath), projectName);
        }
      }
