...
[**ClassList**](annotated.md) **>** [**CogoOperationPointAtDistanceAngle**](classCogoOperationPointAtDistanceAngle.md)
...
| Type | Name |
| ---: | :--- |
|   | [**CogoOperationPointAtDistanceAngle**](#function-cogooperationpointatdistanceangle) () <br> |
...
|   | [**~CogoOperationPointAtDistanceAngle**](#function-cogooperationpointatdistanceangle) () = default<br> |
...
### function CogoOperationPointAtDistanceAngle 

```C++
inline CogoOperationPointAtDistanceAngle::CogoOperationPointAtDistanceAngle () 
```
...
```C++
virtual bool CogoOperationPointAtDistanceAngle::checkReadiness (
...
```C++
inline virtual QString CogoOperationPointAtDistanceAngle::displayName () override const
```
...
```C++
virtual bool CogoOperationPointAtDistanceAngle::execute (
...
```C++
inline virtual QString CogoOperationPointAtDistanceAngle::icon () override const
```
...
```C++
inline virtual QString CogoOperationPointAtDistanceAngle::name () override const
```
...
```C++
virtual QList< CogoParameter > CogoOperationPointAtDistanceAngle::parameters (
    Qgis::WkbType wkbType
) override const
```
...
```C++
virtual QList< CogoVisualGuide > CogoOperationPointAtDistanceAngle::visualGuides (
    const QVariantMap & parameters,
...
```C++
CogoOperationPointAtDistanceAngle::~CogoOperationPointAtDistanceAngle () = default
```
