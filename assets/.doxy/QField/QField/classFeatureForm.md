...
Inherits the following classes: [QfFeatureForm](classQfFeatureForm.md)
...
## Public Properties inherited from QfFeatureForm

See [QfFeatureForm](classQfFeatureForm.md)
...
| property [**AttributeFormModel**](classAttributeFormModel.md) | [**model**](classQfFeatureForm.md#property-model)  <br> |
...
## Public Signals inherited from QfFeatureForm
...
## Public Functions inherited from QfFeatureForm

See [QfFeatureForm](classQfFeatureForm.md)

| Type | Name |
| ---: | :--- |
|  void | [**requestCancel**](classQfFeatureForm.md#function-requestcancel) () <br> |
|  void | [**resetTabs**](classQfFeatureForm.md#function-resettabs) () <br> |
...
------------------------------
The documentation for this class was generated from the following file `src/app/qml_compat/FeatureForm.qml`
