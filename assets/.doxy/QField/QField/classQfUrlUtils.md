...
[**ClassList**](annotated.md) **>** [**QfUrlUtils**](classQfUrlUtils.md)
...
| Type | Name |
| ---: | :--- |
|   | [**QfUrlUtils**](#function-qfurlutils) (QObject \* parent=nullptr) <br> |
...
```C++
explicit QfUrlUtils::QfUrlUtils (
...
```C++
static Q_INVOKABLE QString QfUrlUtils::createActionUrl (
...
```C++
static Q_INVOKABLE QString QfUrlUtils::createEncodedUrl (
...
```C++
static Q_INVOKABLE QUrl QfUrlUtils::fromString (
    const QString & url
) 
```
...
```C++
static Q_INVOKABLE QVariantMap QfUrlUtils::getActionDetails (
    const QString & url
) 
```
...
```C++
static Q_INVOKABLE bool QfUrlUtils::isRelativeOrFileUrl (
    const QString & url
) 
```
...
```C++
static Q_INVOKABLE QString QfUrlUtils::toLocalFile (
    const QString & url
) 
```
...
```C++
static Q_INVOKABLE QString QfUrlUtils::urlDetail (
    const QString & url,
...
------------------------------
The documentation for this class was generated from the following file `src/core/utils/qfurlutils.h`
