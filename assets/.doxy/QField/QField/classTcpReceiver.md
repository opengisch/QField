...
|   | [**~TcpReceiver**](#function-tcpreceiver) () <br> |
...
```C++
virtual AbstractGnssReceiver::Capabilities TcpReceiver::capabilities () override const
```



Implements [*NmeaGnssReceiver::capabilities*](classNmeaGnssReceiver.md#function-capabilities)
