...
[**ClassList**](annotated.md) **>** [**BluetoothReceiver**](classBluetoothReceiver.md)
...
| Type | Name |
| ---: | :--- |
| slot void | [**onCorrectionDataReceived**](classBluetoothReceiver.md#slot-oncorrectiondatareceived) (const QByteArray & data) <br> |
| slot QString | [**socketStateString**](classBluetoothReceiver.md#slot-socketstatestring)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**BluetoothReceiver**](#function-bluetoothreceiver) (const QString & address=QString(), QObject \* parent=nullptr) <br> |
| virtual AbstractGnssReceiver::Capabilities | [**capabilities**](#function-capabilities) () override const<br> |
|   | [**~BluetoothReceiver**](#function-bluetoothreceiver) () <br> |
...
The bluetoothreceiver connects to a device and feeds the QgsNmeaConnection over QBluetoothSocket. It receives QgsGpsInformation and converts it to [**GnssPositionInformation**](classGnssPositionInformation.md) 
