...
# Class QfEditorWidgetRelationReference



[**ClassList**](annotated.md) **>** [**QfEditorWidgetRelationReference**](classQfEditorWidgetRelationReference.md)
...
| Type | Name |
| ---: | :--- |
| property bool | [**showOpenFormButton**](classQfEditorWidgetRelationReference.md#property-showopenformbutton)  <br> |
...
```C++
bool QfEditorWidgetRelationReference::showOpenFormButton;
```
...
------------------------------
The documentation for this class was generated from the following file `src/gui/qml/editorwidgets/QfEditorWidgetRelationReference.qml`
