...
[**ClassList**](annotated.md) **>** [**QfLayerTreeMapCanvasBridge**](classQfLayerTreeMapCanvasBridge.md)
...
| Type | Name |
| ---: | :--- |
|   | [**QfLayerTreeMapCanvasBridge**](#function-qflayertreemapcanvasbridge) ([**QfFlatLayerTreeModel**](classQfFlatLayerTreeModel.md) \* model, [**QgsQuickMapSettings**](classQgsQuickMapSettings.md) \* mapSettings, [**QfTrackingModel**](classQfTrackingModel.md) \* trackingModel, QObject \* parent=nullptr) <br>_Constructor: does not take ownership of the layer tree nor canvas._  |
...
### function QfLayerTreeMapCanvasBridge 

_Constructor: does not take ownership of the layer tree nor canvas._ 
```C++
QfLayerTreeMapCanvasBridge::QfLayerTreeMapCanvasBridge (
    QfFlatLayerTreeModel * model,
...
```C++
inline bool QfLayerTreeMapCanvasBridge::autoEnableCrsTransform () const
```
...
```C++
inline bool QfLayerTreeMapCanvasBridge::autoSetupOnFirstLayer () const
```
...
```C++
inline QgsQuickMapSettings * QfLayerTreeMapCanvasBridge::mapSettings () const
```
...
```C++
inline QgsLayerTree * QfLayerTreeMapCanvasBridge::rootGroup () const
```
...
```C++
inline void QfLayerTreeMapCanvasBridge::setAutoEnableCrsTransform (
    bool enabled
) 
```
...
```C++
inline void QfLayerTreeMapCanvasBridge::setAutoSetupOnFirstLayer (
    bool enabled
) 
```
...
```C++
Q_INVOKABLE void QfLayerTreeMapCanvasBridge::setCanvasLayers () 
```
...
------------------------------
The documentation for this class was generated from the following file `src/core/qflayertreemapcanvasbridge.h`
