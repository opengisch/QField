...
| property double | [**storageThresholdCritical**](structCloudSubscriptionInformation.md#property-storagethresholdcritical)  <br> |
| property double | [**storageThresholdWarning**](structCloudSubscriptionInformation.md#property-storagethresholdwarning)  <br> |
...
```C++
double CloudSubscriptionInformation::storageThresholdCritical;
```
...
```C++
double CloudSubscriptionInformation::storageThresholdWarning;
```
