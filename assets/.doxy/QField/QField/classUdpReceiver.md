...
[**ClassList**](annotated.md) **>** [**UdpReceiver**](classUdpReceiver.md)
...
| Type | Name |
| ---: | :--- |
| slot QString | [**socketStateString**](classUdpReceiver.md#slot-socketstatestring)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**UdpReceiver**](#function-udpreceiver) (const QString & address=QString(), const int port=0, QObject \* parent=nullptr) <br> |
|   | [**~UdpReceiver**](#function-udpreceiver) () override<br> |
...
The [**UdpReceiver**](classUdpReceiver.md) connects to a device and feeds the QgsNmeaConnection over a UDP socket. It receives QgsGpsInformation and converts it to [**GnssPositionInformation**](classGnssPositionInformation.md) 
...
```C++
QLatin1String UdpReceiver::identifier;
```
...
```C++
explicit UdpReceiver::UdpReceiver (
...
```C++
UdpReceiver::~UdpReceiver () override
```
...
------------------------------
The documentation for this class was generated from the following file `src/core/positioning/udpreceiver.h`
