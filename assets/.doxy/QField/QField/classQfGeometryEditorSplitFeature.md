...
# Class QfGeometryEditorSplitFeature



[**ClassList**](annotated.md) **>** [**QfGeometryEditorSplitFeature**](classQfGeometryEditorSplitFeature.md)
...
| Type | Name |
| ---: | :--- |
| property bool | [**blocking**](classQfGeometryEditorSplitFeature.md#property-blocking)  <br> |
| property bool | [**screenHovering**](classQfGeometryEditorSplitFeature.md#property-screenhovering)  <br> |
...
| property [**FeatureModel**](classFeatureModel.md) | [**featureModel**](classQfGeometryEditorBase.md#property-featuremodel)  <br> |
...
```C++
bool QfGeometryEditorSplitFeature::blocking;
```
...
```C++
bool QfGeometryEditorSplitFeature::screenHovering;
```
...
```C++
void QfGeometryEditorSplitFeature::cancel () 
```
...
```C++
void QfGeometryEditorSplitFeature::canvasClicked (
    point,
    type
) 
```
...
```C++
void QfGeometryEditorSplitFeature::canvasLongPressed (
    point,
    type
) 
```
...
```C++
void QfGeometryEditorSplitFeature::init (
    featureModel,
    mapSettings,
