...
# Class QfCogoOperationPointAtDistanceAngle



[**ClassList**](annotated.md) **>** [**QfCogoOperationPointAtDistanceAngle**](classQfCogoOperationPointAtDistanceAngle.md)



_A COGO operation to generate a point at a given distance and angle from a provided point._ 
...
| Type | Name |
| ---: | :--- |
|   | [**QfCogoOperationPointAtDistanceAngle**](#function-qfcogooperationpointatdistanceangle) () <br> |
...
|   | [**~QfCogoOperationPointAtDistanceAngle**](#function-qfcogooperationpointatdistanceangle) () = default<br> |
...
### function QfCogoOperationPointAtDistanceAngle 

```C++
inline QfCogoOperationPointAtDistanceAngle::QfCogoOperationPointAtDistanceAngle () 
```
...
```C++
virtual bool QfCogoOperationPointAtDistanceAngle::checkReadiness (
...
```C++
inline virtual QString QfCogoOperationPointAtDistanceAngle::displayName () override const
```
...
```C++
virtual bool QfCogoOperationPointAtDistanceAngle::execute (
...
```C++
inline virtual QString QfCogoOperationPointAtDistanceAngle::icon () override const
```
...
```C++
inline virtual QString QfCogoOperationPointAtDistanceAngle::name () override const
```
...
```C++
virtual QList< QfCogoParameter > QfCogoOperationPointAtDistanceAngle::parameters (
    Qgis::WkbType wkbType
) override const
```
...
```C++
virtual QList< QfCogoVisualGuide > QfCogoOperationPointAtDistanceAngle::visualGuides (
    const QVariantMap & parameters,
...
```C++
QfCogoOperationPointAtDistanceAngle::~QfCogoOperationPointAtDistanceAngle () = default
```
