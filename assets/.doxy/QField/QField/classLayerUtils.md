...
|  Q\_INVOKABLE bool | [**deleteFeature**](#function-deletefeature) (QgsProject \* project, QgsVectorLayer \* layer, const QgsFeatureId fid, bool shouldWriteChanges=true) <br> |
...
* `shouldWriteChanges` set to TRUE to immediately save the edit buffer 
