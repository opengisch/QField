...
|  Q\_INVOKABLE [**FeatureIterator**](classFeatureIterator.md) | [**createFeatureIterator**](#function-createfeatureiterator) (QgsVectorLayer \* layer) <br> |
...
```C++
static Q_INVOKABLE QString LayerUtils::guessFriendlyHeightField (
    QgsVectorLayer * layer
) 
```
