...
# Class QfRelationUtils



[**ClassList**](annotated.md) **>** [**QfRelationUtils**](classQfRelationUtils.md)
...
| Type | Name |
| ---: | :--- |
|   | [**QfRelationUtils**](#function-qfrelationutils) (QObject \* parent=nullptr) <br> |
...
### function QfRelationUtils 

```C++
explicit QfRelationUtils::QfRelationUtils (
...
```C++
Q_INVOKABLE QgsPolymorphicRelation QfRelationUtils::addPolymorphicRelation (
    QgsProject * project,
...
```C++
Q_INVOKABLE QgsPolymorphicRelation QfRelationUtils::createPolymorphicRelation (
    const QVariantList & referencedLayers,
    const QgsVectorLayer * referencingLayer,
    const QVariantMap & fieldPairs,
    const QString & referencedLayerField,
...
```C++
Q_INVOKABLE QgsRelation QfRelationUtils::createRelation (
...
```C++
Q_INVOKABLE QgsRelation QfRelationUtils::resolveReferencingRelation (
    QgsProject * project,
...
------------------------------
The documentation for this class was generated from the following file `src/core/utils/qfrelationutils.h`
