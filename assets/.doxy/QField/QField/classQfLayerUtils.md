...
[**ClassList**](annotated.md) **>** [**QfLayerUtils**](classQfLayerUtils.md)
...
| Type | Name |
| ---: | :--- |
|   | [**QfLayerUtils**](#function-qflayerutils) (QObject \* parent=nullptr) <br> |
|  Q\_INVOKABLE QSet&lt; QVariant &gt; | [**uniqueValuesForVectorLayerFieldIndex**](#function-uniquevaluesforvectorlayerfieldindex) (QgsVectorLayer \* layer, int fieldIndex) <br> |
...
|  Q\_INVOKABLE [**QfFeatureIterator**](classQfFeatureIterator.md) | [**createFeatureIterator**](#function-createfeatureiterator) (QgsVectorLayer \* layer) <br> |
|  Q\_INVOKABLE [**QfFeatureIterator**](classQfFeatureIterator.md) | [**createFeatureIteratorFromExpression**](#function-createfeatureiteratorfromexpression) (QgsVectorLayer \* layer, const QString & expression) <br> |
|  Q\_INVOKABLE [**QfFeatureIterator**](classQfFeatureIterator.md) | [**createFeatureIteratorFromRectangle**](#function-createfeatureiteratorfromrectangle) (QgsVectorLayer \* layer, const QgsRectangle & rectangle) <br> |
...
|  Q\_INVOKABLE QString | [**guessFriendlyHeightField**](#function-guessfriendlyheightfield) (QgsVectorLayer \* layer) <br> |
...
|  Q\_INVOKABLE QString | [**saveVectorLayerAs**](#function-savevectorlayeras) (QgsVectorLayer \* layer, const QString & filePath, const QString & driverName=QString(), const QString & filterExpression=QString()) <br> |
...
Returns a list of unique values for a given _fieldIndex_ from the _layer_. 
...
When the layer is not already being edited, the function will call startEditing() and commitChanges(). If editing was started outside of this function, the feature is left in the edit buffer for the caller to commit. 
...
Returns a feature iterator to get all features within the provided _layer_. 
...
Guesses the name of the field in _layer_ most likely to carry a per-feature height/extrusion value, or an empty string when no suitable field is found. 
