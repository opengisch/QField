...
| property QStringList | [**hiddenCollectionNames**](classQfMarkupManager.md#property-hiddencollectionnames-12)  <br> |
...
| signal void | [**hiddenCollectionNamesChanged**](classQfMarkupManager.md#signal-hiddencollectionnameschanged)  <br>_Emitted when the list of hidden collection names has changed._  |
...
|  QStringList | [**hiddenCollectionNames**](#function-hiddencollectionnames-22) () const<br> |
|  Q\_INVOKABLE void | [**reset**](#function-reset) (const QString & path, const QString & prefix=QString()) <br> |
|  void | [**setHiddenCollectionNames**](#function-sethiddencollectionnames) (const QStringList & hiddenCollectionNames) <br> |
...
### property hiddenCollectionNames [1/2]

```C++
QStringList QfMarkupManager::hiddenCollectionNames;
```
...
### signal hiddenCollectionNamesChanged 

_Emitted when the list of hidden collection names has changed._ 
```C++
void QfMarkupManager::hiddenCollectionNamesChanged;
```
...
### function hiddenCollectionNames [2/2]

```C++
inline QStringList QfMarkupManager::hiddenCollectionNames () const
```



Returns the list of collection names that are hidden. Matching collection names will not be part of the list of collections returned by the markup manager visibleCollections() function. 
...
### function setHiddenCollectionNames 

```C++
void QfMarkupManager::setHiddenCollectionNames (
    const QStringList & hiddenCollectionNames
) 
```



Sets the list of collection names that are hidden. Matching collection names will not be part of the list of collections returned by the markup manager visibleCollections() function. 
