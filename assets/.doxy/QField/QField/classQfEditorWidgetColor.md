...
# Class QfEditorWidgetColor



[**ClassList**](annotated.md) **>** [**QfEditorWidgetColor**](classQfEditorWidgetColor.md)
...
| Type | Name |
| ---: | :--- |
| property double | [**desiredHeight**](classQfEditorWidgetColor.md#property-desiredheight)  <br> |
...
```C++
double QfEditorWidgetColor::desiredHeight;
```
...
------------------------------
The documentation for this class was generated from the following file `src/gui/qml/editorwidgets/QfEditorWidgetColor.qml`
