...
| virtual Q\_INVOKABLE [**ResourceSource**](classResourceSource.md) \* | [**getFile**](classPlatformUtilities.md#function-getfile) (const QString & prefix, const QString & filePath, const QString & mimeType=QStringLiteral("\*/\*"), QObject \* parent=nullptr) <br> |
...
| virtual Q\_INVOKABLE void | [**sendCompressedFilesTo**](classPlatformUtilities.md#function-sendcompressedfilesto) (const QStringList & paths) const<br>_Compresses a list of file_ _paths_ _and sends it via the platform native API._ |
...
| virtual Q\_INVOKABLE QString | [**systemLocalDataLocation**](classPlatformUtilities.md#function-systemlocaldatalocation) (const QString & subDir=QString()) const<br> |
...
```C++
virtual void IosPlatformUtilities::exportDatasetTo (
    const QString & path
) override const
```
...
```C++
virtual void IosPlatformUtilities::exportFolderTo (
    const QString & path
) override const
```
...
```C++
virtual void IosPlatformUtilities::importDatasets () override const
```
...
```C++
virtual void IosPlatformUtilities::importProjectArchive () override const
```
...
```C++
virtual void IosPlatformUtilities::importProjectFolder () override const
```
...
```C++
virtual void IosPlatformUtilities::sendCompressedFolderTo (
    const QString & path
) override const
```
...
```C++
virtual void IosPlatformUtilities::sendDatasetTo (
    const QString & path
) override const
```
...
```C++
virtual void IosPlatformUtilities::updateProjectFromArchive (
