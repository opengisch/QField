...
|  QVariantList | [**polylines**](#function-polylines-22) () const<br>_List of polylines representing the rubber band._  |
...
```C++
QVariantList RubberbandShape::polylines;
```
...
_List of polylines representing the rubber band._ 
```C++
inline QVariantList RubberbandShape::polylines () const
```
