...
|  Q\_INVOKABLE bool | [**featuresInTracking**](#function-featuresintracking-12) (QgsVectorLayer \* layer, const QVariantList & features) <br>_Returns TRUE if the list of_ _features_ _is attached to a vector__layer_ _tracking session._ |
|  bool | [**featuresInTracking**](#function-featuresintracking-22) (QgsVectorLayer \* layer, const QList&lt; QgsFeature &gt; & features) <br>_Returns TRUE if the list of_ _features_ _is attached to a vector__layer_ _tracking session._ |
...
### function featuresInTracking [1/2]
...
### function featuresInTracking [2/2]

_Returns TRUE if the list of_ _features_ _is attached to a vector__layer_ _tracking session._
```C++
bool TrackingModel::featuresInTracking (
    QgsVectorLayer * layer,
