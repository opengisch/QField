...
| Type | Name |
| ---: | :--- |
| signal void | [**bytesReceivedChanged**](classNtripClient.md#signal-bytesreceivedchanged)  <br>_Emitted when the received bytes counts have changed._  |
| signal void | [**bytesSentChanged**](classNtripClient.md#signal-bytessentchanged)  <br>_Emitted when the sent bytes counts have changed._  |
