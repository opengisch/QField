...
| property QString | [**attachmentStorageAuthConfigId**](classReferencingFeatureListModel.md#property-attachmentstorageauthconfigid-12)  <br> |
| property QString | [**attachmentStorageType**](classReferencingFeatureListModel.md#property-attachmentstoragetype-12)  <br> |
| property QString | [**attachmentStorageUrl**](classReferencingFeatureListModel.md#property-attachmentstorageurl-12)  <br> |
...
| Type | Name |
| ---: | :--- |
| signal void | [**attachmentDetailsChanged**](classReferencingFeatureListModel.md#signal-attachmentdetailschanged)  <br> |
...
```C++
QString ReferencingFeatureListModel::attachmentStorageAuthConfigId;
```
...
```C++
QString ReferencingFeatureListModel::attachmentStorageType;
```
...
```C++
QString ReferencingFeatureListModel::attachmentStorageUrl;
```
...
```C++
void ReferencingFeatureListModel::attachmentDetailsChanged;
```
...
```C++
bool ReferencingFeatureListModel::lessThan (
