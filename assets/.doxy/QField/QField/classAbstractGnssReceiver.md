...
| virtual AbstractGnssReceiver::Capabilities | [**capabilities**](#function-capabilities) () const<br> |
...
```C++
virtual void AbstractGnssReceiver::onCorrectionDataReceived;
```
...
```C++
void AbstractGnssReceiver::batteryLevelChanged;
```
...
```C++
inline double AbstractGnssReceiver::batteryLevel () const
```
...
```C++
virtual AbstractGnssReceiver::Capabilities AbstractGnssReceiver::capabilities () const
```
