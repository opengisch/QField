...
| property [**FeatureListModelSelection**](classFeatureListModelSelection.md) | [**selectionModel**](classQfMapCanvas3D.md#property-selectionmodel)  <br> |
...
| property [**TrackingModel**](classTrackingModel.md) | [**trackingModel**](classQfMapCanvas3D.md#property-trackingmodel)  <br> |
...
```C++
FeatureListModelSelection QfMapCanvas3D::selectionModel;
```
...
```C++
TrackingModel QfMapCanvas3D::trackingModel;
```
