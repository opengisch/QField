...
| property bool | [**orderByField**](classFeatureCheckListModel.md#property-orderbyfield-12)  <br>_Set to TRUE if features should be ordered by a field._  |
| property QString | [**orderByFieldName**](classFeatureCheckListModel.md#property-orderbyfieldname-12)  <br>_Field to sort features over._  |
...
| signal void | [**orderByFieldChanged**](classFeatureCheckListModel.md#signal-orderbyfieldchanged)  <br> |
| signal void | [**orderByFieldNameChanged**](classFeatureCheckListModel.md#signal-orderbyfieldnamechanged)  <br> |
...
```C++
bool FeatureCheckListModel::orderByField;
```
...
```C++
QString FeatureCheckListModel::orderByFieldName;
```
...
```C++
void FeatureCheckListModel::orderByFieldChanged;
```
...
```C++
void FeatureCheckListModel::orderByFieldNameChanged;
```
...
```C++
Q_INVOKABLE int FeatureCheckListModel::rowCount (
...
```C++
void FeatureCheckListModel::setOrderByField (
    bool orderByField
) 
```
...
```C++
void FeatureCheckListModel::setOrderByFieldName (
...
------------------------------
The documentation for this class was generated from the following file `src/gui/featurechecklistmodel.h`
