...
|  Q\_INVOKABLE QgsGeometry | [**geometryFromRubberband**](#function-geometryfromrubberband) ([**QfRubberbandModel**](classQfRubberbandModel.md) \* rubberBandModel, const QgsCoordinateReferenceSystem & crs, double mapUnitsPerPoint, Qgis::WkbType wkbType=Qgis::WkbType::Unknown) <br>_Returns a QgsGeometryfrom a rubberband model. The wktType is unknown, the type will be determined from the shape formed by the point sequence in the rubberband model.._  |
...
### function geometryFromRubberband 

_Returns a QgsGeometryfrom a rubberband model. The wktType is unknown, the type will be determined from the shape formed by the point sequence in the rubberband model.._ 
```C++
static Q_INVOKABLE QgsGeometry QfGeometryUtils::geometryFromRubberband (
    QfRubberbandModel * rubberBandModel,
