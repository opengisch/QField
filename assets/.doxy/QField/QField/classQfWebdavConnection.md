...
[**ClassList**](annotated.md) **>** [**QfWebdavConnection**](classQfWebdavConnection.md)
...
| Type | Name |
| ---: | :--- |
| property QStringList | [**availablePaths**](classQfWebdavConnection.md#property-availablepaths-12)  <br> |
| property QStringList | [**checkedPaths**](classQfWebdavConnection.md#property-checkedpaths-12)  <br> |
| property bool | [**isDownloadingPath**](classQfWebdavConnection.md#property-isdownloadingpath-12)  <br> |
| property bool | [**isFetchingAvailablePaths**](classQfWebdavConnection.md#property-isfetchingavailablepaths-12)  <br> |
| property bool | [**isImportingPath**](classQfWebdavConnection.md#property-isimportingpath-12)  <br> |
| property bool | [**isPasswordStored**](classQfWebdavConnection.md#property-ispasswordstored-12)  <br> |
| property bool | [**isUploadingPath**](classQfWebdavConnection.md#property-isuploadingpath-12)  <br> |
| property QString | [**lastError**](classQfWebdavConnection.md#property-lasterror-12)  <br> |
| property QString | [**password**](classQfWebdavConnection.md#property-password-12)  <br> |
| property double | [**progress**](classQfWebdavConnection.md#property-progress-12)  <br> |
| property bool | [**storePassword**](classQfWebdavConnection.md#property-storepassword-12)  <br> |
| property QString | [**url**](classQfWebdavConnection.md#property-url-12)  <br> |
| property QString | [**username**](classQfWebdavConnection.md#property-username-12)  <br> |
...
| Type | Name |
| ---: | :--- |
| signal void | [**availablePathsChanged**](classQfWebdavConnection.md#signal-availablepathschanged)  <br> |
| signal void | [**checkedPathsChanged**](classQfWebdavConnection.md#signal-checkedpathschanged)  <br> |
| signal void | [**confirmationRequested**](classQfWebdavConnection.md#signal-confirmationrequested) (const QString & host, const QString & username) <br> |
| signal void | [**importSuccessful**](classQfWebdavConnection.md#signal-importsuccessful) (const QString & path) <br> |
| signal void | [**isDownloadingPathChanged**](classQfWebdavConnection.md#signal-isdownloadingpathchanged)  <br> |
| signal void | [**isFetchingAvailablePathsChanged**](classQfWebdavConnection.md#signal-isfetchingavailablepathschanged)  <br> |
| signal void | [**isImportingPathChanged**](classQfWebdavConnection.md#signal-isimportingpathchanged)  <br> |
| signal void | [**isPasswordStoredChanged**](classQfWebdavConnection.md#signal-ispasswordstoredchanged)  <br> |
| signal void | [**isUploadingPathChanged**](classQfWebdavConnection.md#signal-isuploadingpathchanged)  <br> |
| signal void | [**lastErrorChanged**](classQfWebdavConnection.md#signal-lasterrorchanged)  <br> |
| signal void | [**passwordChanged**](classQfWebdavConnection.md#signal-passwordchanged)  <br> |
| signal void | [**progressChanged**](classQfWebdavConnection.md#signal-progresschanged)  <br> |
| signal void | [**storePasswordChanged**](classQfWebdavConnection.md#signal-storepasswordchanged)  <br> |
| signal void | [**uploadFinished**](classQfWebdavConnection.md#signal-uploadfinished) (bool success, const QString & message) <br> |
| signal void | [**uploadSkipped**](classQfWebdavConnection.md#signal-uploadskipped) (const QString & reason) <br> |
| signal void | [**urlChanged**](classQfWebdavConnection.md#signal-urlchanged)  <br> |
| signal void | [**usernameChanged**](classQfWebdavConnection.md#signal-usernamechanged)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**QfWebdavConnection**](#function-qfwebdavconnection) (QObject \* parent=nullptr) <br> |
...
|   | [**~QfWebdavConnection**](#function-qfwebdavconnection) () = default<br> |
...
**See also:** [**fetchAvailablePaths**](classQfWebdavConnection.md#function-fetchavailablepaths) 
...
Before the upload starts, confirmationRequested() is emitted so the UI can ask the user to confirm. Call [**confirmRequest()**](classQfWebdavConnection.md#function-confirmrequest) to proceed or [**cancelRequest()**](classQfWebdavConnection.md#function-cancelrequest) to abort. 
