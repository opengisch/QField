...
[[ $(apk_version_code v1.2.3 x86-android) != 010203993 ]] && echo "=> failed" && exit 1 || echo "OK"
[[ $(apk_version_code v1.2.3-rc4 arm64-android) != 010203042 ]] && echo "=> failed" && exit 1 || echo "OK"
