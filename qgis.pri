...
android {
  ...
  LIBS += $${OSGEO4A_STAGE_DIR}/$$ANDROID_TARGET_ARCH$$/lib/libqgis_core_$${ANDROID_TARGET_ARCH}.so
  LIBS += $${OSGEO4A_STAGE_DIR}/$$ANDROID_TARGET_ARCH$$/lib/libqgis_analysis_$${ANDROID_TARGET_ARCH}.so
}
