function(build_msvc build_type source_path)
    ...
    # zlib 1.3.2 renamed the Windows libraries: z/zd (dynamic), zs/zsd (static)
    if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
        set(ZLIB_LIB_RELEASE "zs.lib")
        set(ZLIB_LIB_DEBUG "zsd.lib")
    else()
        set(ZLIB_LIB_RELEASE "z.lib")
        set(ZLIB_LIB_DEBUG "zd.lib")
    endif()
